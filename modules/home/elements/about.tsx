      ...
      <div className='flex flex-col-reverse gap-5 md:gap-0 md:flex-row items-center'>
        <div className='w-full md:w-1/2 h-full flex justify-center'>
          <div className='w-fit h-full'>
            <img src="/img/src/mobile2.svg" alt="mobile" width={'100%'} height={'100%'} className='bg-cover max-h-[500px]' />
          </div>
        </div>
        <div className='w-full md:w-1/2 flex flex-col gap-7'>
          <div className='flex gap-3 items-center'>
            <TbCloudComputing strokeWidth='1' className='w-14 md:w-20 h-full text-green-600' />
            <div className='h-fit'>
              <h2 className='text-2xl font-semibold md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600'>About Me</h2>
          ...
          <div>
            ...
            <p className='flex gap-3'>Universitas Tekonologi Yogyakarta
              <a target='_blank' aria-label='School Location'
                href="https://maps.app.goo.gl/GsVERFpXo8kWRwjc9">
