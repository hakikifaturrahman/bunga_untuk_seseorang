      ...
      flex flex-col duration-300
        ...
        <li>
          <Link href='/' onClick={() => handleMobileNav(false, ' ')}
            ...
            <img src="/icon-circle.svg" alt="icon-circle.svg" width='80' height='80'
        ...
        dark:bg-neutral-800'>
          ...
          <div className='flex gap-4 my-2'>
            {brandLink(TbBrandInstagram, 'https://www.instagram.com/hakiki_ftr?igsh=NmV1aHl6MTRuOTJx&utm_source=qr')}
            {brandLink(TbBrandGithub, 'https://github.com/hakikifaturrahman')}
            {brandLink(TbBrandYoutube, 'https://youtube.com/@hakikifaturrahmanas8020?si=tuc9nsKd2pZtLyc4')}
            {brandLink(TbBrandLinkedin, 'https://www.linkedin.com/in/hakiki-faturrahman-66974839b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app')}
            {brandLink(TbBrandTiktok, 'https://www.tiktok.com/@bangikiii01?_r=1&_t=ZS-92XdbJAEdmr')}
          </div>
        </li>
      </ul>
    </nav>
